...
export const NEXT_BUTTON_TEXT = 'bulk.enrollment.learners.btn.previous';
export const PREVIOUS_BUTTON_TEXT = 'bulk.enrollment.learners.btn.next';
...
export const ADD_COURSES_TITLE = 'bulk.enrollment.learners.add.course.add.courses';
...
export const ADD_COURSE_DESCRIPTION = 'bulk.enrollment.learners.add.course.description';
